      ...
      <div className='relative w-full max-w-md max-h-full'>
        <div className=''>
          <div className='flex justify-between'>
            ...
            <h3 className=' mb-2 font-medium text-lg md:text-xl text-black dark:text-gray-200'>Tạo người kiểm duyệt</h3>
          ...
          <section className='w-full mx-auto items-center '>
            <form className=' w-full px-4 lg:px-5 py-5 rounded-lg mx-auto ' onSubmit={onSubmit} noValidate>
              ...
              />
              <Input
                title='User name của người kiểm duyệt'
                placeholder='Nhập user name của người kiểm duyệt'
                register={register}
              ...
              />
              <Input
                title='Email của người kiểm duyệt'
                placeholder='Nhập email của người kiểm duyệt'
                register={register}
                errors={errors.email}
                type='email'
                name='email'
