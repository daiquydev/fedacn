...
% Consolas thường thiếu đủ dấu tiếng Việt trong \texttt → dùng Courier New (Windows).
...
\fancypagestyle{plain}{%
    ...
    \fancyhead[L]{
        ...
        \begin{tabular}{l}
        	\small Trường Đại Học Bách Khoa TP.Hồ Chí Minh\\
        	\small Khoa Khoa Học \& Kỹ Thuật Máy Tính
        \end{tabular} 	
        \end{tabular}
    }
    \fancyhead[R]{
    ...
    \fancyfoot{}
    \fancyfoot[L]{\scriptsize Đồ án Tốt Nghiệp - Học kỳ 252\\}
    \fancyfoot[R]{\scriptsize Trang {\thepage}}
  \renewcommand{\headrulewidth}{0.4pt}
  \renewcommand{\footrulewidth}{0.4pt}
}
% Đồng bộ với plain: fancyhdr mặc định \pagestyle{fancy} chỉ có số trang giữa;
% một số trang (float, gói khác) có thể chuyển sang fancy → gán fancy = plain.
\fancypagestyleassign{fancy}{plain}
...
\begin{flushright}
\begin{tabular}{ll}
\textbf{HỘI ĐỒNG:} & Hội đồng 21L Khoa học Máy tính \\
\textbf{GVPB:} & CN. Lê Bình Đẳng \\
...
\tableofcontents
\pagestyle{plain}% Nội dung sau mục lục dùng cùng header/footer đã cấu hình (plain = fancy sau assign)
\makeatother
...
\chapter{HIỆN THỰC VÀ TRIỂN KHAI HỆ THỐNG}
\renewcommand*{\theHsection}{\theHchapter.\the\value{section}}
\input{project-setup}
...
% Tài liệu tham khảo đặt trước Phụ lục theo chuẩn trình bày báo cáo
