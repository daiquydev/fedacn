...
Sơ đồ ERD tổng quan gồm \textbf{10 thực thể chính}, lấy \textbf{User} làm trung tâm liên kết. Bảng~\ref{tab:erd_entities} mô tả vai trò của từng thực thể.

\begin{table}[H]
\centering
\caption{Vai trò các thực thể trong sơ đồ ERD tổng quan}
\label{tab:erd_entities}
\small
\renewcommand{\arraystretch}{1.2}
\begin{tabular}{|p{3.8cm}|p{10.2cm}|}
\hline
\textbf{Thực thể} & \textbf{Vai trò trong hệ thống} \\
\hline
\textbf{User} & Thực thể trung tâm: đăng bài, tương tác, theo dõi bạn bè; tạo/tham gia sự kiện và thử thách; lập giáo án và quản lý lịch cá nhân. \\
\hline
\textbf{Post} & Bài đăng trên bảng tin cộng đồng (1 User, đa phương tiện, kiểm soát hiển thị công khai/bạn bè/riêng tư, nhận like và bình luận). \\
\hline
\textbf{SportsEvent} & Sự kiện thể thao tập thể: hỗ trợ hình thức Ngoài trời (GPS) và Trong nhà (Video Call + AI nhận diện khuôn mặt). \\
\hline
\textbf{Participant (SportsEvent)} & Thực thể trung gian ghi nhận đăng ký tham gia, mục tiêu cá nhân và tiến độ thi đua; phục vụ bảng xếp hạng nội bộ sự kiện. \\
\hline
\textbf{Challenge} & Thử thách rèn luyện kỷ luật ngắn hạn (3 loại: dinh dưỡng, bài tập, ngoài trời); hỗ trợ tạo thủ công hoặc AI đề xuất; check-in tiến độ hằng ngày. \\
\hline
\textbf{Participant (Challenge)} & Thực thể trung gian ghi nhận mục tiêu, kết quả check-in từng ngày và bảng xếp hạng nội bộ thử thách. \\
\hline
\textbf{Workout} & Giáo án tập luyện cá nhân (tự tạo hoặc AI đề xuất), liên kết tập hợp \textbf{Exercise}; có thể lưu vào lịch và theo dõi lịch sử. \\
\hline
\textbf{Exercise} & Kho bài tập đơn lẻ: nhóm cơ mục tiêu, kỹ thuật, cấu hình hiệp/lần/thời gian; được \textbf{Workout} tham chiếu để xây dựng lộ trình. \\
\hline
\textbf{Dashboard} & Phân hệ Admin: giám sát tăng trưởng, quản lý người dùng/sự kiện, xử lý báo cáo vi phạm, cấu hình danh mục thể thao. \\
\hline
\textbf{Calendar} & Lịch cá nhân tổng hợp tự động từ sự kiện, thử thách và tập luyện; gửi thông báo nhắc nhở đúng thời điểm. \\
\hline
\end{tabular}
\end{table}
