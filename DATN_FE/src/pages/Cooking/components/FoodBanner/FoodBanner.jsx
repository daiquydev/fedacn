    ...
    <div className='bg-gray'>
      <Slider {...settings}>
        <div className='h-[22rem]'>
          <div className='h-full border dark:border-none shadow shadow-green-400 md:rounded-lg w-full overflow-hidden'>
            ...
            <div className='absolute z-10 lg:bottom-10 md:bottom-8 bottom-0 lg:px-7 md:px-10 px-4 py-4'>
              ...
              <button
                ...
                className='btn font-blod leading-none text-gray-800 bg-white hover:bg-slate-300 border-green-500 px-2 py-0.5 mt-3 text-center'
              >
                Xem ngay
              </button>
            </div>
