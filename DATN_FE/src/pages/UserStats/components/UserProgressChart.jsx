...
const UserProgressChart = ({ healthMetricsHistory = [], activityHistory = [], userProfile }) => {
  ...
  const CaloriesColumnChart = ({ data }) => {
    if (!data || data.length === 0) return <p className="text-center text-gray-500">Không có dữ liệu kcal</p>;

    // Lọc dữ liệu có calories
    const caloriesData = data.filter(d => d.caloriesBurned > 0);

    if (caloriesData.length === 0) return <p className="text-center text-gray-500">Không có dữ liệu kcal</p>;
    ...
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 mb-6 animate-[fadeIn_0.5s_ease-in-out]">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-4 mb-5">
        ...
        <div className="flex flex-wrap gap-3">
          <button
            ...
            className={`flex-1 min-w-[120px] px-4 py-3 text-sm rounded-md flex items-center justify-center transition-all duration-300 ${activeChart === 'line'
          ...
          <button
            ...
            className={`flex-1 min-w-[120px] px-4 py-3 text-sm rounded-md flex items-center justify-center transition-all duration-300 ${activeChart === 'column'
          ...
          <button
            ...
            className={`flex-1 min-w-[120px] px-4 py-3 text-sm rounded-md flex items-center justify-center transition-all duration-300 ${activeChart === 'pie'
      ...
      <div className="mb-4">
        <button
          ...
          className={`w-full px-4 py-3 rounded-md transition-all duration-300 flex items-center justify-center ${showDetailTable
                  ...
                  >
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      {item.activitiesCount ? (
                        <span className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium ${item.completedActivities === item.activitiesCount
