...
export default function ModalUploadCoverAvatar({ closeModalCoverAvatar }) {
  ...
  return (
    <ModalLayout closeModal={closeModalCoverAvatar} title='Chọn ảnh bìa' icon={FaImage} size='md'>
      <div className='p-5'>
        <div
        ...
        >
          {image ? (
            <img
              className='h-48 w-full rounded-xl border-2 border-emerald-500 object-cover shadow-lg'
              src={URL.createObjectURL(image)}
              alt='cover'
            />
          ) : (
            <div className='h-48 w-full flex flex-col justify-center items-center bg-gray-50 dark:bg-gray-800 border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-xl cursor-pointer hover:border-emerald-400 transition-colors'>
              <FaCloudUploadAlt className='text-3xl text-gray-400 dark:text-gray-500 mb-2' />
              <span className='text-sm font-medium text-gray-500 dark:text-gray-400'>Chọn ảnh bìa</span>
        ...
        <div className='flex gap-3 mt-6'>
          ...
          <button
            ...
            disabled={updateCoverAvatarMutation.isPending || !image}
