  ...
  return (
    <footer className='footer mt-[40rem] items-center p-4 bg-gray-200 dark:bg-color-primary-dark dark:text-gray-400 text-xs text-gray-700'>
      <aside className='items-center grid-flow-col'>
        ...
        <p>Copyright © 2025 - By Nguyen Tuan Khanh</p>
      </aside>
      <nav className='grid-flow-col gap-4 md:place-self-center md:justify-self-end'>
        ...
        <a href="#" className="text-gray-600 hover:text-blue-400 dark:text-gray-400 dark:hover:text-blue-300 transition-colors">
          <FaTwitter size={20} />
        </a>
