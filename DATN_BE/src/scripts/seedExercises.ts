...
const exerciseSeed: ExerciseSeedData[] = [
    ...
    { name: 'Incline Push-Up', name_vi: 'Chống đẩy nghiêng', equipment_keys: ['bodyweight', 'bench'], primary_muscle_keys: ['chest'], secondary_muscle_keys: ['triceps'], category: 'strength', difficulty: 'beginner', duration_default: 30, rest_time_default: 45, instructions: ['Đặt tay lên ghế/bậc cao', 'Chống đẩy như bình thường'], tips: 'Phù hợp cho người mới bắt đầu', video_url: '', image_url: '' },
    { name: 'Dumbbell Bench Press', name_vi: 'Đẩy ngực tạ tay', equipment_keys: ['dumbbell', 'bench'], primary_muscle_keys: ['chest'], secondary_muscle_keys: ['triceps', 'front-deltoids'], category: 'strength', difficulty: 'intermediate', duration_default: 40, rest_time_default: 60, instructions: ['Nằm trên ghế phẳng, tay cầm tạ', 'Đưa tạ lên cao, hai tay thẳng', 'Hạ tạ từ từ xuống ngang ngực', 'Đẩy tạ lên'], tips: 'Giữ khuỷu tay 45 độ so với thân', video_url: '', image_url: '' },
    { name: 'Barbell Bench Press', name_vi: 'Đẩy ngực tạ đòn', equipment_keys: ['barbell', 'bench'], primary_muscle_keys: ['chest'], secondary_muscle_keys: ['triceps', 'front-deltoids'], category: 'strength', difficulty: 'intermediate', duration_default: 40, rest_time_default: 90, instructions: ['Nằm ghế phẳng, nắm thanh tạ rộng ngang vai', 'Hạ tạ xuống ngực', 'Đẩy tạ lên thẳng'], tips: 'Luôn có người hỗ trợ khi tập nặng', video_url: '', image_url: '' },
    ...
    { name: 'Band Push-Up', name_vi: 'Chống đẩy dây kháng lực', equipment_keys: ['band', 'bodyweight'], primary_muscle_keys: ['chest'], secondary_muscle_keys: ['triceps'], category: 'strength', difficulty: 'intermediate', duration_default: 30, rest_time_default: 45, instructions: ['Vòng dây qua lưng, hai đầu dây dưới tay', 'Chống đẩy bình thường với thêm lực kháng'], tips: 'Tăng dần độ căng dây', video_url: '', image_url: '' },

    // === BACK ===
    { name: 'Pull-Up', name_vi: 'Kéo xà', equipment_keys: ['pull-up-bar'], primary_muscle_keys: ['upper-back'], secondary_muscle_keys: ['biceps', 'forearm'], category: 'strength', difficulty: 'intermediate', duration_default: 30, rest_time_default: 60, instructions: ['Bám xà, tay rộng hơn vai', 'Kéo người lên cho cằm qua xà', 'Hạ từ từ'], tips: 'Nếu chưa kéo được, dùng dây hỗ trợ', video_url: '', image_url: '' },
    { name: 'Chin-Up', name_vi: 'Kéo xà ngửa tay', equipment_keys: ['pull-up-bar'], primary_muscle_keys: ['upper-back'], secondary_muscle_keys: ['biceps'], category: 'strength', difficulty: 'intermediate', duration_default: 30, rest_time_default: 60, instructions: ['Bám xà, hai tay ngửa hẹp ngang vai', 'Kéo người lên'], tips: 'Tập trung cảm nhận lưng và biceps', video_url: '', image_url: '' },
    { name: 'Barbell Row', name_vi: 'Chèo tạ đòn', equipment_keys: ['barbell'], primary_muscle_keys: ['upper-back'], secondary_muscle_keys: ['biceps', 'lower-back'], category: 'strength', difficulty: 'intermediate', duration_default: 40, rest_time_default: 60, instructions: ['Cúi người 45 độ, nắm tạ đòn', 'Kéo tạ lên bụng', 'Hạ từ từ'], tips: 'Giữ lưng thẳng, không gù', video_url: '', image_url: '' },
    ...
    { name: 'Lat Pulldown', name_vi: 'Kéo cáp xổ', equipment_keys: ['plate'], primary_muscle_keys: ['upper-back'], secondary_muscle_keys: ['biceps'], category: 'strength', difficulty: 'beginner', duration_default: 40, rest_time_default: 60, instructions: ['Ngồi máy, nắm thanh rộng', 'Kéo thanh xuống trước ngực', 'Trả từ từ'], tips: 'Không ngả người quá xa', video_url: '', image_url: '' },
    { name: 'Inverted Row', name_vi: 'Chèo ngược cơ thể', equipment_keys: ['bodyweight', 'pull-up-bar'], primary_muscle_keys: ['upper-back'], secondary_muscle_keys: ['biceps', 'forearm'], category: 'strength', difficulty: 'beginner', duration_default: 30, rest_time_default: 45, instructions: ['Bám xà thấp, nằm ngửa dưới xà', 'Kéo ngực lên chạm xà'], tips: 'Giữ thân thẳng', video_url: '', image_url: '' },
    { name: 'Deadlift', name_vi: 'Nâng tạ chết', equipment_keys: ['barbell'], primary_muscle_keys: ['lower-back'], secondary_muscle_keys: ['hamstring', 'gluteal', 'trapezius'], category: 'strength', difficulty: 'intermediate', duration_default: 40, rest_time_default: 120, instructions: ['Đứng rộng ngang hông, nắm tạ đòn', 'Đứng thẳng lên nâng tạ theo người', 'Hạ tạ từ từ theo đường thẳng'], tips: 'QUAN TRỌNG: Giữ lưng thẳng tuyệt đối', video_url: '', image_url: '' },
    { name: 'Kettlebell Swing', name_vi: 'Xoay tạ ấm', equipment_keys: ['kettlebell'], primary_muscle_keys: ['lower-back'], secondary_muscle_keys: ['gluteal', 'hamstring'], category: 'cardio', difficulty: 'intermediate', duration_default: 30, rest_time_default: 45, instructions: ['Đứng rộng hơn vai, cầm tạ ấm', 'Đung đưa tạ qua chân', 'Đẩy hông mạnh để xoay tạ lên ngang vai'], tips: 'Lực từ hông, không phải tay', video_url: '', image_url: '' },

    // === SHOULDERS ===
    { name: 'Dumbbell Shoulder Press', name_vi: 'Đẩy vai tạ tay', equipment_keys: ['dumbbell'], primary_muscle_keys: ['front-deltoids'], secondary_muscle_keys: ['triceps', 'trapezius'], category: 'strength', difficulty: 'intermediate', duration_default: 40, rest_time_default: 60, instructions: ['Ngồi/đứng, tạ ngang tai', 'Đẩy tạ lên trên đầu', 'Hạ từ từ về ngang tai'], tips: 'Không khóa khuỷu tay khi đẩy hết', video_url: '', image_url: '' },
    { name: 'Barbell Overhead Press', name_vi: 'Đẩy vai tạ đòn', equipment_keys: ['barbell'], primary_muscle_keys: ['front-deltoids'], secondary_muscle_keys: ['triceps', 'trapezius'], category: 'strength', difficulty: 'intermediate', duration_default: 40, rest_time_default: 90, instructions: ['Đứng, tạ ngang vai', 'Đẩy tạ thẳng lên đầu', 'Hạ từ từ'], tips: 'Siết core để ổn định', video_url: '', image_url: '' },
    { name: 'Dumbbell Lateral Raise', name_vi: 'Nâng tạ ngang vai', equipment_keys: ['dumbbell'], primary_muscle_keys: ['front-deltoids'], secondary_muscle_keys: ['trapezius'], category: 'strength', difficulty: 'beginner', duration_default: 40, rest_time_default: 45, instructions: ['Đứng thẳng, tạ hai bên hông', 'Nâng tạ ngang ra hai bên lên ngang vai', 'Hạ từ từ'], tips: 'Tạ nhẹ, nhiều lần lặp', video_url: '', image_url: '' },
    ...
    { name: 'Wall Sit', name_vi: 'Ngồi tường', equipment_keys: ['bodyweight'], primary_muscle_keys: ['quadriceps'], secondary_muscle_keys: [], category: 'strength', difficulty: 'beginner', duration_default: 45, rest_time_default: 60, instructions: ['Tựa lưng vào tường', 'Hạ người cho đùi song song mặt đất', 'Giữ tư thế'], tips: 'Bài tập isometric tốt', video_url: '', image_url: '' },
    { name: 'Leg Press', name_vi: 'Đạp chân máy', equipment_keys: ['plate'], primary_muscle_keys: ['quadriceps'], secondary_muscle_keys: ['gluteal', 'hamstring'], category: 'strength', difficulty: 'beginner', duration_default: 40, rest_time_default: 60, instructions: ['Ngồi máy leg press', 'Đạp tấm nặng lên bằng hai chân', 'Hạ từ từ'], tips: 'Không khóa đầu gối', video_url: '', image_url: '' },
    { name: 'Leg Extension', name_vi: 'Duỗi chân máy', equipment_keys: ['plate'], primary_muscle_keys: ['quadriceps'], secondary_muscle_keys: [], category: 'strength', difficulty: 'beginner', duration_default: 40, rest_time_default: 45, instructions: ['Ngồi máy, đặt chân dưới gối đệm', 'Duỗi thẳng chân', 'Hạ từ từ'], tips: 'Cô lập đùi trước', video_url: '', image_url: '' },

    // === LEGS - HAMSTRING & GLUTES ===
    { name: 'Romanian Deadlift', name_vi: 'Nâng tạ chết Romania', equipment_keys: ['barbell', 'dumbbell'], primary_muscle_keys: ['hamstring'], secondary_muscle_keys: ['gluteal', 'lower-back'], category: 'strength', difficulty: 'intermediate', duration_default: 40, rest_time_default: 90, instructions: ['Đứng, cầm tạ trước đùi', 'Gập hông đẩy mông ra sau', 'Hạ tạ theo ống chân', 'Đứng thẳng lên'], tips: 'Cảm nhận căng đùi sau', video_url: '', image_url: '' },
    { name: 'Hip Thrust', name_vi: 'Đẩy hông', equipment_keys: ['barbell', 'bench'], primary_muscle_keys: ['gluteal'], secondary_muscle_keys: ['hamstring'], category: 'strength', difficulty: 'intermediate', duration_default: 40, rest_time_default: 60, instructions: ['Lưng tựa ghế, tạ trên hông', 'Đẩy hông lên', 'Hạ từ từ'], tips: 'Siết mông ở đỉnh', video_url: '', image_url: '' },
    { name: 'Glute Bridge', name_vi: 'Cầu mông', equipment_keys: ['bodyweight'], primary_muscle_keys: ['gluteal'], secondary_muscle_keys: ['hamstring'], category: 'strength', difficulty: 'beginner', duration_default: 30, rest_time_default: 30, instructions: ['Nằm ngửa, đầu gối co', 'Đẩy hông lên cao', 'Siết mông, hạ từ từ'], tips: 'Giữ 2 giây ở đỉnh', video_url: '', image_url: '' },
    { name: 'Leg Curl', name_vi: 'Cuốn chân máy', equipment_keys: ['plate'], primary_muscle_keys: ['hamstring'], secondary_muscle_keys: ['calves'], category: 'strength', difficulty: 'beginner', duration_default: 40, rest_time_default: 45, instructions: ['Nằm sấp trên máy', 'Co chân kéo gối đệm về phía mông', 'Hạ từ từ'], tips: 'Cô lập đùi sau', video_url: '', image_url: '' },
    { name: 'Step-Up', name_vi: 'Bước lên bục', equipment_keys: ['bodyweight', 'dumbbell', 'bench'], primary_muscle_keys: ['quadriceps'], secondary_muscle_keys: ['gluteal'], category: 'strength', difficulty: 'beginner', duration_default: 40, rest_time_default: 45, instructions: ['Đặt một chân lên bục/ghế', 'Đẩy người đứng lên', 'Hạ chân kia xuống'], tips: 'Bục cao ngang đầu gối', video_url: '', image_url: '' },

    // === CALVES ===
    { name: 'Calf Raise', name_vi: 'Nâng bắp chân', equipment_keys: ['bodyweight', 'dumbbell'], primary_muscle_keys: ['calves'], secondary_muscle_keys: [], category: 'strength', difficulty: 'beginner', duration_default: 40, rest_time_default: 30, instructions: ['Đứng trên mép bậc thang', 'Nâng gót chân lên cao', 'Hạ từ từ dưới mức bậc'], tips: 'Giữ 1 giây ở đỉnh', video_url: '', image_url: '' },
    { name: 'Seated Calf Raise', name_vi: 'Nâng bắp chân ngồi', equipment_keys: ['plate', 'bench'], primary_muscle_keys: ['calves'], secondary_muscle_keys: [], category: 'strength', difficulty: 'beginner', duration_default: 40, rest_time_default: 30, instructions: ['Ngồi, đặt tạ trên đùi', 'Nâng gót chân'], tips: 'Tập cơ dép', video_url: '', image_url: '' },

    // === ABS ===
    { name: 'Crunch', name_vi: 'Gập bụng', equipment_keys: ['bodyweight'], primary_muscle_keys: ['abs'], secondary_muscle_keys: [], category: 'strength', difficulty: 'beginner', duration_default: 30, rest_time_default: 30, instructions: ['Nằm ngửa, đầu gối co', 'Cuốn thân lên, vai rời sàn', 'Hạ từ từ'], tips: 'Không kéo cổ', video_url: '', image_url: '' },
    { name: 'Plank', name_vi: 'Plank giữ', equipment_keys: ['bodyweight'], primary_muscle_keys: ['abs'], secondary_muscle_keys: ['lower-back', 'front-deltoids'], category: 'strength', difficulty: 'beginner', duration_default: 60, rest_time_default: 30, instructions: ['Chống khuỷu tay, thân thẳng', 'Giữ tư thế'], tips: 'Không để hông chùng', video_url: '', image_url: '' },
    ...
    { name: 'Russian Twist', name_vi: 'Xoay Nga', equipment_keys: ['bodyweight', 'dumbbell'], primary_muscle_keys: ['obliques'], secondary_muscle_keys: ['abs'], category: 'strength', difficulty: 'beginner', duration_default: 30, rest_time_default: 30, instructions: ['Ngồi, chân nâng khỏi sàn', 'Xoay thân sang hai bên'], tips: 'Thêm tạ để tăng độ khó', video_url: '', image_url: '' },
    { name: 'Mountain Climber', name_vi: 'Leo núi', equipment_keys: ['bodyweight'], primary_muscle_keys: ['abs'], secondary_muscle_keys: ['quadriceps', 'front-deltoids'], category: 'cardio', difficulty: 'beginner', duration_default: 30, rest_time_default: 30, instructions: ['Tư thế plank', 'Kéo đầu gối lên ngực luân phiên nhanh'], tips: 'Giữ hông ổn định', video_url: '', image_url: '' },
    { name: 'Ab Rollout', name_vi: 'Lăn con lăn bụng', equipment_keys: ['bodyweight'], primary_muscle_keys: ['abs'], secondary_muscle_keys: ['lower-back', 'front-deltoids'], category: 'strength', difficulty: 'intermediate', duration_default: 30, rest_time_default: 45, instructions: ['Quỳ, cầm dụng cụ lăn', 'Lăn ra trước', 'Cuốn thân kéo lại'], tips: 'Siết bụng suốt quá trình', video_url: '', image_url: '' },
    { name: 'Bicycle Crunch', name_vi: 'Gập bụng xe đạp', equipment_keys: ['bodyweight'], primary_muscle_keys: ['abs'], secondary_muscle_keys: ['obliques'], category: 'strength', difficulty: 'beginner', duration_default: 30, rest_time_default: 30, instructions: ['Nằm ngửa, tay sau đầu', 'Kéo gối phải chạm khuỷu trái và ngược lại'], tips: 'Xoay thân, không kéo cổ', video_url: '', image_url: '' },
    { name: 'Side Plank', name_vi: 'Plank nghiêng', equipment_keys: ['bodyweight'], primary_muscle_keys: ['obliques'], secondary_muscle_keys: ['abs'], category: 'strength', difficulty: 'beginner', duration_default: 45, rest_time_default: 30, instructions: ['Nằm nghiêng, chống khuỷu tay', 'Nâng hông lên, thân thẳng', 'Giữ tư thế'], tips: 'Không để hông sụp', video_url: '', image_url: '' },

    // === TRAPEZIUS ===
    { name: 'Barbell Shrug', name_vi: 'Nhún vai tạ đòn', equipment_keys: ['barbell'], primary_muscle_keys: ['trapezius'], secondary_muscle_keys: [], category: 'strength', difficulty: 'beginner', duration_default: 40, rest_time_default: 45, instructions: ['Đứng cầm tạ trước đùi', 'Nhún vai lên cao', 'Hạ từ từ'], tips: 'Không xoay vai', video_url: '', image_url: '' },
    { name: 'Dumbbell Shrug', name_vi: 'Nhún vai tạ tay', equipment_keys: ['dumbbell'], primary_muscle_keys: ['trapezius'], secondary_muscle_keys: [], category: 'strength', difficulty: 'beginner', duration_default: 40, rest_time_default: 45, instructions: ['Cầm tạ hai bên hông', 'Nhún vai lên'], tips: 'Giữ 1 giây ở đỉnh', video_url: '', image_url: '' },

    // === FOREARM ===
    { name: 'Wrist Curl', name_vi: 'Cuốn cổ tay', equipment_keys: ['dumbbell', 'barbell'], primary_muscle_keys: ['forearm'], secondary_muscle_keys: [], category: 'strength', difficulty: 'beginner', duration_default: 40, rest_time_default: 30, instructions: ['Tay đặt trên đùi/ghế, cổ tay buông ngoài mép', 'Cuốn cổ tay lên'], tips: 'Tạ nhẹ, nhiều lần lặp', video_url: '', image_url: '' },
    { name: 'Farmer Walk', name_vi: 'Đi nông dân', equipment_keys: ['dumbbell', 'kettlebell'], primary_muscle_keys: ['forearm'], secondary_muscle_keys: ['trapezius', 'abs'], category: 'strength', difficulty: 'beginner', duration_default: 60, rest_time_default: 60, instructions: ['Cầm tạ nặng hai tay', 'Đi bộ thẳng lưng'], tips: 'Tốt cho sức bám tay', video_url: '', image_url: '' },

    // === CARDIO & FULL BODY ===
    { name: 'Burpees', name_vi: 'Burpees', equipment_keys: ['bodyweight'], primary_muscle_keys: ['chest'], secondary_muscle_keys: ['quadriceps', 'abs', 'front-deltoids'], category: 'cardio', difficulty: 'intermediate', duration_default: 30, rest_time_default: 45, instructions: ['Đứng, hạ người xuống squat', 'Đặt tay xuống sàn, nhảy chân ra sau thành plank', 'Chống đẩy 1 cái', 'Nhảy chân về, đứng lên nhảy'], tips: 'Đốt calo cực kỳ hiệu quả', video_url: '', image_url: '' },
    { name: 'Jumping Jack', name_vi: 'Nhảy tách chân', equipment_keys: ['bodyweight'], primary_muscle_keys: ['quadriceps'], secondary_muscle_keys: ['calves', 'front-deltoids'], category: 'cardio', difficulty: 'beginner', duration_default: 30, rest_time_default: 20, instructions: ['Đứng, nhảy tách chân đồng thời vỗ tay trên đầu', 'Nhảy về'], tips: 'Tốt cho khởi động', video_url: '', image_url: '' },
    { name: 'High Knees', name_vi: 'Nâng gối cao', equipment_keys: ['bodyweight'], primary_muscle_keys: ['quadriceps'], secondary_muscle_keys: ['abs', 'calves'], category: 'cardio', difficulty: 'beginner', duration_default: 30, rest_time_default: 20, instructions: ['Chạy tại chỗ, nâng gối cao quá hông'], tips: 'Giữ nhịp nhanh', video_url: '', image_url: '' },
    { name: 'Jump Squat', name_vi: 'Squat nhảy', equipment_keys: ['bodyweight'], primary_muscle_keys: ['quadriceps'], secondary_muscle_keys: ['gluteal', 'calves'], category: 'plyometrics', difficulty: 'intermediate', duration_default: 30, rest_time_default: 45, instructions: ['Squat xuống', 'Nhảy thật cao', 'Tiếp đất mềm mại quay lại squat'], tips: 'Tiếp đất nhẹ nhàng bằng mũi chân', video_url: '', image_url: '' },

    // === STRETCHING ===
    { name: 'Standing Quad Stretch', name_vi: 'Giãn đùi trước đứng', equipment_keys: ['bodyweight'], primary_muscle_keys: ['quadriceps'], secondary_muscle_keys: [], category: 'stretching', difficulty: 'beginner', duration_default: 30, rest_time_default: 15, instructions: ['Đứng 1 chân, kéo gót chân kia chạm mông'], tips: 'Giữ 15-30 giây mỗi bên', video_url: '', image_url: '' },
...
async function seedAll() {
    try {
        ...
        // Helper: generate default sets based on difficulty & category
        function generateDefaultSets(difficulty: string, category: string) {
            if (category === 'stretching') {
                return [{ set_number: 1, reps: 1, weight: 0, weight_unit: 'kg' }]
            }
            if (category === 'cardio') {
                return [
                    { set_number: 1, reps: 1, weight: 0, weight_unit: 'kg' },
                    { set_number: 2, reps: 1, weight: 0, weight_unit: 'kg' },
                    { set_number: 3, reps: 1, weight: 0, weight_unit: 'kg' }
                ]
            }
            // strength / plyometrics
            const config: Record<string, { sets: number; reps: number }> = {
        ...
        const exerciseDocs = exerciseSeed.map(ex => ({
            ...
            default_sets: generateDefaultSets(ex.difficulty, ex.category),
            is_active: true
        }))
