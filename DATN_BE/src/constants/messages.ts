...
export const USER_MEAL_SCHEDULE_MESSAGE = {
  ...
  RESCHEDULE_MEAL_ITEM_SUCCESS: 'Thay đổi lịch món ăn thành công',
  SWAP_MEAL_ITEMS_SUCCESS: 'Hoán đổi món ăn thành công',
  ADD_MEAL_ITEM_SUCCESS: 'Thêm món ăn vào lịch thành công',
  REMOVE_MEAL_ITEM_SUCCESS: 'Xóa món ăn khỏi lịch thành công',
  UPDATE_MEAL_ITEM_SUCCESS: 'Cập nhật món ăn thành công',
